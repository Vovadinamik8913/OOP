...
import ru.nsu.abramenko.dsl.CourseConfiguration;
import ru.nsu.abramenko.dsl.Group;
import ru.nsu.abramenko.dsl.Student;
import ru.nsu.abramenko.dsl.TaskAssignment;
import ru.nsu.abramenko.util.Download;
import ru.nsu.abramenko.util.GitHubCommitCounter;
import ru.nsu.abramenko.util.Run;
import ru.nsu.abramenko.util.TableBuild;
import ru.nsu.abramenko.util.TestsAndDocs;
...
public class App {
    ...
    public static void main(String[] args) {
        ...
        URI configPath = Objects.requireNonNull(App.class.getClassLoader()
                .getResource("dsl/main.dsl")).toURI(); //путь к конфигу
